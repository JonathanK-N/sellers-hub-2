...
class PaymentResult:
    def __init__(self, ok: bool, reference: str, status: str, raw: Optional[dict] = None, error: Optional[str] = None):
        self.ok = ok
    ...
    def to_dict(self) -> dict:
        return {"ok": self.ok, "reference": self.reference, "status": self.status, "raw": self.raw, "error": self.error}
