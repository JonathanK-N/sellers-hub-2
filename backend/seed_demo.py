...
def img(photo_id, w=800, h=600):
    return f"https://images.unsplash.com/photo-{photo_id}?w={w}&h={h}&q=80&fit=crop&auto=format"

# Logos boutiques (carrés)
LOGO_ELECTRO   = img("1468495244123-b6c099a5a55b", 200, 200)
LOGO_MODE      = img("1558618666-fcd25c85cd64", 200, 200)
LOGO_AGRI      = img("1574323347407-f5e1ad6962eb", 200, 200)
LOGO_SOLAR     = img("1509391366360-2e959784a276", 200, 200)
LOGO_MAISON    = img("1556909114-f6e7ad7d3136", 200, 200)

# Bannières boutiques (paysage)
BAN_ELECTRO    = img("1518770660439-4636190af475", 1200, 400)
BAN_MODE       = img("1441986300917-64674bd600d8", 1200, 400)
BAN_AGRI       = img("1500937386664-43d2b5e87f48", 1200, 400)
BAN_SOLAR      = img("1509391366360-2e959784a276", 1200, 400)
BAN_MAISON     = img("1556909114-f6e7ad7d3136", 1200, 400)
    ...
    "products": [
      {
        ...
        "photos": [
          ...
          img("1601784551446-c5982b7a0a90"),
      ...
      },
      {
        ...
        "photos": [img("1558618047-3d3b36c25f53"), img("1591799266444-d82c08f72dd1")],
      ...
      },
      {
        ...
        "photos": [img("1609091839311-d5365f9ff1c5"), img("1585790050230-5dd28404ccb9")],
    ...
    "products": [
      {
        ...
        "photos": [
          img("1606503825685-a2ce2df34dac"),
          img("1590735213920-68192a45851d"),
      ...
      },
      {
        ...
        "photos": [
          img("1548036161-65efbebb7c51"),
          img("1547996160-49bf6a2d0b73"),
        ],
    ...
    "products": [
      {
        ...
        "photos": [
          img("1536304929831-ee1ca9d44906"),
          img("1586201375761-83865001e31d"),
        ],
      ...
      },
      {
        ...
        "photos": [img("1474979266404-7f3d8a0d4c60"), img("1556909114-f6e7ad7d3136")],
      ...
      },
      {
        ...
        "photos": [img("1574323347407-f5e1ad6962eb"), img("1546069901-ba9599a7b63a")],
      ...
      },
      {
        ...
        "photos": [img("1508747703725-719bb0a25ee5"), img("1626965870524-a08334a8e5c7")],
    ...
    "products": [
      {
        ...
        "photos": [
          ...
          img("1508514177221-188b1af16fe3"),
          img("1466611653911-0265a2a22a44"),
        ],
      ...
      },
      {
        ...
        "photos": [img("1466611653911-0265a2a22a44"), img("1508514177221-188b1af16fe3")],
      ...
      },
      {
        ...
        "photos": [img("1558618047-3d3b36c25f53"), img("1609091839311-d5365f9ff1c5")],
    ...
    "products": [
      {
        ...
        "photos": [
          img("1585771724684-38796367dc07"),
      ...
      },
      {
        ...
        "photos": [img("1556909114-f6e7ad7d3136"), img("1584990347209-28f7d9f24b52")],
      ...
      },
      {
        ...
        "photos": [img("1490818387583-1d2537e787d4"), img("1556909172-54557c7e4fb7")],
      ...
      },
      {
        ...
        "photos": [img("1558618666-fcd25c85cd64"), img("1513694203232-719a6b369a2a")],
